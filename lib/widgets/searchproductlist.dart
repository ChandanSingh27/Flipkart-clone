...
class _SearchProductListsState extends State<SearchProductLists> {
              ...
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Responsive.isMoblie(context)
                        ? showProductMobile(context, products, index,
                            randomNumber, randomNumberForPercentage)
                        : showProductDesktop(context, products, index,
                            randomNumber, randomNumberForPercentage);
                  },
                )
  ...
  InkWell showProductDesktop(BuildContext context, List<ProductModel> products,
      int index, int randomNumber, int randomNumberForPercentage) {
    return InkWell(
      onTap: () {
        Navigator.push(
            context,
...
InkWell showProductMobile(BuildContext context, List<ProductModel> products,
    int index, int randomNumber, int randomNumberForPercentage) {
  return InkWell(
    onTap: () {
      Navigator.push(
