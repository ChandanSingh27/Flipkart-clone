...
class _CartPageState extends State<CartPage> {
    ...
    return Scaffold(
      ...
      body: Column(children: [
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                child: Responsive.isMoblie(context)
                    ? productDetailsForMobile(products, index, randomNumber,
                        randomNumberForPercentage, context)
                    : productDetailsForDesktop(products, index, randomNumber,
                        randomNumberForPercentage, context),
              );
            },
          )),
        if (products.isEmpty)
          const Expanded(
              child: Center(
            child: Text("No Product Add To Cart"),
          )),
        footer(context)
      ]),
    );
  ...
  Row productDetailsForDesktop(List<ProductModel> products, int index,
      int randomNumber, int randomNumberForPercentage, BuildContext context) {
    return Row(
...
Row productDetailsForMobile(List<ProductModel> products, int index,
    int randomNumber, int randomNumberForPercentage, BuildContext context) {
  return Row(
    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      ...
      Column(
          ...
          children: [
            Text(
              products[index].itemName.length > 10
                  ? '${products[index].itemName.substring(0, 10)}...'
                  : products[index].itemName,
              style: dialogBoxBlackColorTextStyle,
            ),
            const SizedBox(
            ...
            Text(
              products[index].itemDesc.length > 15
                  ? '${products[index].itemDesc.substring(0, 15)}...'
                  : products[index].itemDesc,
              overflow: TextOverflow.ellipsis,
              maxLines: 1,
              style: bannerItemWidgetsTextStyle,
